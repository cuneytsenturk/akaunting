...
use App\Traits\OAuth\HasOAuthScopes;
...
{
    use HasApiTokens, HasFactory, HasOAuthScopes, HasRelationships, LaratrustUserTrait, Media, Notifiable, Owners, SearchString, SoftDeletes, Sortable, Sources, Tenants, Users;
