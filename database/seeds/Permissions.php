    ...
    private function create()
    {
        $rows = [
            'admin' => [
                ...
                'settings-oauth' => 'r,u',
                'settings-oauth-activity' => 'r',
                'settings-oauth-dashboard' => 'r',
                'settings-oauth-scopes' => 'c,r,u,d',
            ...
            'manager' => [
                ...
                'settings-modules' => 'r,u',
                'settings-o-auth' => 'r,u',
                'settings-o-auth-activity' => 'r',
                'settings-o-auth-dashboard' => 'r',
                'settings-o-auth-scopes' => 'c,r,u,d',
                'settings-schedule' => 'r,u',
                'settings-taxes' => 'c,r,u,d',
                'widgets-account-balance' => 'r',
                'widgets-bank-feeds' => 'r',
